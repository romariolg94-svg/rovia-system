...
const serviceCards = [
  {
    icon: Fingerprint,
    title: "Control Acces",
    text: "Sisteme avansate de control acces pentru securitatea spațiilor tale.",
  },
  {
    icon: Camera,
    title: "Sisteme de Supraveghere",
    text: "Soluții video performante pentru monitorizare 24/7.",
  },
  {
    icon: Settings,
    title: "Sisteme Inteligente",
    text: "Automatizări și soluții smart care îți optimizează afacerea.",
  },
  {
    icon: Code2,
    title: "Dezvoltare Software",
    text: "Aplicații și platforme software personalizate pentru nevoile tale.",
  },
];
...
const extraServices = [
  [Code2, "Software la comandă", "ERP, CRM, pontaj, gestiune, aplicații web, dashboard-uri și integrări."],
  [Network, "Rețelistică", "Cablare structurată, switch-uri, VLAN, WiFi enterprise și infrastructură completă."],
  [Server, "Servere & Backup", "Implementare, mentenanță, monitorizare, backup și soluții cloud/on-premise."],
  [Shield, "Sisteme efracție", "Sisteme de securitate, senzori, centrale, control acces și integrare tehnică."],
  [Camera, "CCTV & IP video", "Camere IP, NVR, servere video, monitorizare și mentenanță periodică."],
  [Wrench, "Mentenanță echipamente", "Suport tehnic, intervenții, optimizare și mentenanță pentru echipamente IT."],
] as const;
...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#020b18] pt-[92px] text-white">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#00a6ff22_1px,transparent_1px),linear-gradient(to_bottom,#00a6ff1c_1px,transparent_1px)] bg-[size:80px_80px] opacity-35" />
      ...
      <div className="relative mx-auto grid min-h-[650px] max-w-[1500px] grid-cols-1 items-center px-5 md:px-10 lg:grid-cols-[1fr_1.1fr]">
        <motion.div
          ...
          className="z-10 max-w-[650px] py-16"
        >
          <div className="mb-7 flex items-center gap-4 text-[13px] uppercase tracking-[0.16em] text-slate-300 md:text-[15px]">
            <span className="h-[2px] w-14 bg-[#009dff]" />
            Smart Solutions. Real Results.
          </div>

          <h1 className="text-[42px] font-black leading-[1.08] tracking-[-0.04em] md:text-[72px]">
            Soluții inteligente <br />
            pentru <span className="text-[#008cff]">afacerea ta</span>
          </h1>

          <p className="mt-7 max-w-[620px] text-[17px] leading-8 text-slate-100 md:text-[19px]">
            Oferim soluții integrate de control acces, supraveghere, sisteme inteligente și dezvoltare software
            pentru a-ți transforma ideile în rezultate reale.
          </p>

          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            <a
              className="inline-flex items-center justify-center gap-3 rounded-lg bg-[#008cff] px-8 py-4 font-bold uppercase text-white hover:bg-[#00a6ff]"
              href="#solutii"
            >
              <Users size={20} /> Vezi soluțiile
            </a>

            <a
              className="inline-flex items-center justify-center gap-3 rounded-lg border border-white/35 px-8 py-4 font-bold uppercase text-white hover:bg-white/10"
              href="#contact"
            >
              <Mail size={20} /> Contactează-ne
            </a>
          </div>
        </motion.div>
      ...
      <div className="relative mx-auto flex max-w-[1500px] flex-wrap justify-between gap-8 px-5 pb-8 text-[16px] text-slate-200 md:px-10">
        <Feature icon={<Shield />} text="Soluții personalizate" />
        <Feature icon={<Users />} text="Suport dedicat" />
        <Feature icon={<Settings />} text="Tehnologie de ultimă generație" />
        <Feature icon={<BarChart3 />} text="Performanță și fiabilitate" />
      </div>
    </section>
  );
}
  ...
  return (
    <div className="absolute inset-0">
      ...
      <motion.div
        ...
        className="absolute right-3 top-[80px] h-[420px] w-[420px] rounded-full border border-cyan-400/40 shadow-[0_0_80px_#008cff99]"
      >
        <div className="absolute inset-8 rounded-full border border-cyan-400/40" />
        <div className="absolute inset-16 rounded-full border border-cyan-300/30" />
        <div className="absolute inset-24 rounded-full border border-cyan-300/20" />
      </motion.div>

      <div className="absolute right-5 top-[180px] h-[155px] w-[335px] rotate-[-8deg] rounded-[40px] bg-gradient-to-br from-slate-200 via-slate-500 to-slate-950 shadow-2xl">
        <div className="absolute left-[-18px] top-[34px] h-[92px] w-[115px] rounded-full bg-[#020916] shadow-inner" />
        <div className="absolute left-[10px] top-[56px] h-[48px] w-[48px] rounded-full bg-black ring-8 ring-slate-800" />
      </div>

      <div className="absolute right-2 top-[330px] h-[45px] w-[210px] rounded bg-slate-800" />
      <div className="absolute right-[-15px] top-[360px] h-[130px] w-[35px] bg-slate-900" />

      <FloatingIcon className="right-[420px] top-[95px]" icon={<Lock />} />
      <FloatingIcon className="right-[500px] top-[260px]" icon={<User />} />
      <FloatingIcon className="right-[365px] top-[390px]" icon={<BarChart3 />} />
      <FloatingIcon className="right-[210px] top-[430px]" icon={<Settings />} />
    </div>
  );
}
...
function Feature({ icon, text }: { icon: React.ReactNode; text: string }) {
  return (
    <div className="flex items-center gap-4">
      <span className="text-[#009dff]">{icon}</span>
      <span>{text}</span>
    </div>
  );
}
...
function Services() {
  return (
    <section id="solutii" className="bg-[#f7faff] py-10 pb-14 text-[#071427]">
      <Title title="Soluțiile noastre" dark />
      ...
      <div className="mx-auto mt-8 grid max-w-[1400px] grid-cols-1 gap-7 px-5 md:grid-cols-2 md:px-10 lg:grid-cols-4">
        {serviceCards.map((card) => {
          ...
          return (
            <div
              key={card.title}
              className="flex min-h-[155px] items-center gap-6 rounded-xl border border-slate-200 bg-white p-6 shadow-[0_10px_25px_rgba(15,23,42,0.08)]"
            >
              ...
              <div>
                ...
                <a
                  className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-[#008cff]"
                  href="#contact"
                >
...
function WhyChoose() {
  const items = [
    [Shield, "Experiență și încredere", "O echipă cu experiență practică în proiecte software, IT și securitate."],
    [Users, "Soluții personalizate", "Fiecare proiect este adaptat nevoilor și fluxurilor reale ale clientului."],
    [Headphones, "Suport dedicat", "Suntem alături de tine înainte, în timpul și după implementare."],
    [Rocket, "Tehnologie avansată", "Folosim tehnologii moderne pentru rezultate stabile și scalabile."],
  ] as const;

  return (
    <section id="despre" className="relative overflow-hidden bg-[#020b18] py-16 text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_left,#008cff30,transparent_25%),radial-gradient(circle_at_right,#008cff20,transparent_30%)]" />

      <div className="relative">
        <Title title="De ce să alegi Rovia System?" />

        <div className="mx-auto mt-12 grid max-w-[1400px] grid-cols-1 gap-8 px-5 md:grid-cols-4 md:px-10">
          {items.map(([Icon, title, text], index) => (
            <div key={title} className={`px-5 md:px-8 ${index !== 0 ? "md:border-l md:border-white/25" : ""}`}>
              <Icon className="mb-7 text-[#168dff]" size={58} strokeWidth={1.7} />
    ...
    <section id="software" className="bg-[#f7faff] py-14 text-[#071427]">
      ...
      <div className="mx-auto mt-10 grid max-w-[1450px] grid-cols-1 gap-6 px-5 md:grid-cols-2 md:px-10 lg:grid-cols-3 xl:grid-cols-6">
        {softwareCards.map((item) => (
          <div
            key={item.name}
            className="group overflow-hidden rounded-xl border border-slate-200 bg-white shadow-[0_10px_25px_rgba(15,23,42,0.08)] duration-300 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(0,140,255,0.25)]"
          >
            ...
            <div className="p-5">
              <h3 className="mb-2 text-sm font-black uppercase tracking-wide text-[#006ee6]">
                {item.name}
              </h3>

              <h4 className="text-lg font-bold text-[#071427]">{item.title}</h4>

              <p className="mt-4 min-h-[95px] text-sm leading-6 text-slate-700">
                {item.text}
              </p>

              <a
                className="mt-5 inline-flex items-center gap-2 font-semibold text-[#008cff]"
                href="#contact"
              >
  ...
  return (
    <section id="servicii" className="bg-[#020b18] py-24">
      ...
      <div className="mx-auto mt-14 grid max-w-[1400px] grid-cols-1 gap-6 px-5 md:grid-cols-2 md:px-10 lg:grid-cols-3">
        {extraServices.map(([Icon, title, text]) => (
          <div
            key={title}
...
function Process() {
  return (
    <section className="bg-[#f7faff] py-24 text-[#071427]">
      <Title title="Procesul nostru de lucru" dark />

      <div className="mx-auto mt-14 grid max-w-[1200px] grid-cols-1 gap-5 px-5 md:grid-cols-3 md:px-10 lg:grid-cols-6">
        {processSteps.map((step, index) => (
          <div
            key={step}
            className="rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-[0_10px_25px_rgba(15,23,42,0.08)]"
          >
    ...
    <section className="relative overflow-hidden bg-[#06142a] py-24">
      ...
      <div className="relative mx-auto max-w-5xl px-5 text-center">
        ...
        <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-300">
          Un singur partener pentru aplicații software, sisteme inteligente, supraveghere, infrastructură IT și
          mentenanță.
        </p>

        <a
          href="#contact"
          className="mt-9 inline-flex items-center gap-3 rounded-lg bg-[#008cff] px-9 py-5 font-black uppercase text-white hover:bg-[#00a6ff]"
        >
      ...
      <div className="mx-auto grid max-w-[1250px] grid-cols-1 gap-10 px-5 md:px-10 lg:grid-cols-2">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-black md:text-6xl">
            Hai să digitalizăm compania ta.
          </h2>
        ...
        <div className="rounded-3xl bg-[#020b18] p-8 text-white shadow-2xl">
          <div className="space-y-5">
            <ContactLine icon={<Mail />} text="contact@roviasystem.ro" />
            <ContactLine icon={<Phone />} text="Telefon: de completat" />
            <ContactLine icon={<MapPin />} text="Brașov, România" />
          </div>

          <a
            href="mailto:contact@roviasystem.ro"
            className="mt-8 inline-flex items-center gap-2 rounded-lg bg-[#008cff] px-7 py-4 font-bold text-white hover:bg-[#00a6ff]"
          >
...
function Title({ title, dark = false }: { title: string; dark?: boolean }) {
  return (
    <div className="text-center">
      <h2 className={`text-4xl font-black tracking-tight ${dark ? "text-[#071427]" : "text-white"}`}>
        {title}
      </h2>
